...
pageTitle: 让 AI Agent 自己管理 aweskill — aweskill
description: 让 coding agent 自己完成 aweskill 引导、安装 Skills、创建 Bundle、检查更新，并在需要时修复本地 Skill 状态。
date: "2026-05-05"
readTime: 7 分钟阅读
langHref: /articles/let-your-ai-agent-manage-aweskill-for-you
headings:
  - id: 旧流程你在管理-agent-的工具
    text: 旧流程
    level: 2
  - id: aweskill-的方式给-agent-一个协议
    text: 给 Agent 一个协议
    level: 2
  - id: 引导完成后agent-能做什么
    text: Agent 能做什么
    level: 2
  - id: 使用案例-1初始化一个全新的-agent
    text: 初始化新 Agent
    level: 2
  - id: 使用案例-2让-agent-找一个-skill-并安装
    text: 找 Skill 并安装
    level: 2
  - id: 使用案例-3用对话创建项目-bundle
    text: 创建 Bundle
    level: 2
  - id: 使用案例-4让-agent-检查更新
    text: 检查更新
    level: 2
  - id: 使用案例-5让-agent-修复-skill-状态
    text: 修复 Skill 状态
    level: 2
  - id: 使用案例-6把一套可用配置迁移到另一个-agent
    text: 迁移配置
    level: 2
  - id: 使用案例-7在高风险修改前先备份
    text: 先备份
