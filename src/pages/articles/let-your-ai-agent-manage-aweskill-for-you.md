...
pageTitle: Let Your AI Agent Manage aweskill for You — aweskill
description: A practical guide to letting coding agents bootstrap aweskill, install Skills, build Bundles, check updates, and repair local Skill state.
date: "2026-05-05"
readTime: 7 min read
langHref: /zh/articles/let-your-ai-agent-manage-aweskill-for-you
headings:
  - id: the-old-workflow-you-manage-the-agents-tools
    text: The Old Workflow
    level: 2
  - id: the-aweskill-workflow-give-the-agent-a-protocol
    text: Give the Agent a Protocol
    level: 2
  - id: what-the-agent-can-do-after-bootstrap
    text: What the Agent Can Do
    level: 2
  - id: use-case-1-bootstrap-a-fresh-agent
    text: Bootstrap a Fresh Agent
    level: 2
  - id: use-case-2-ask-the-agent-to-find-and-install-a-skill
    text: Find and Install a Skill
    level: 2
  - id: use-case-3-build-a-project-bundle-by-conversation
    text: Build a Bundle
    level: 2
  - id: use-case-4-let-the-agent-check-for-updates
    text: Check for Updates
    level: 2
  - id: use-case-5-ask-the-agent-to-repair-skill-state
    text: Repair Skill State
    level: 2
  - id: use-case-6-migrate-a-working-setup-to-another-agent
    text: Migrate Setup
    level: 2
  - id: use-case-7-back-up-before-a-risky-change
    text: Back Up First
    level: 2
  - id: why-this-matters
